    ...
    <form action="/booking/store" method="POST" class="booking-form">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="date" class="form-input" name="check_in" value="{{ $booking['check_in'] }}" required>
            </div>
            <div class="form-group">
                <label class="form-label">Ngày trả phòng</label>
                <input type="date" class="form-input" name="check_out" value="{{ $booking['check_out'] }}" required>
            </div>
        </div>

        <div class="form-group">
            <label class="form-label">Số lượng khách</label>
            <input type="number" class="form-input" name="guests" value="{{ $booking['guests'] }}" min="1" max="{{ $booking['capacity'] ?? 1 }}" required>
        </div>
